...
type Book = { googleBooksId:string; title:string; authors:string[]; description:string | null; pageCount:number | null; coverUrl:string | null; isbn13:string | null };
...
export default function Home() {
  ...
  async function saveBook(book:Book) {
    setSavingId(book.googleBooksId); setMessage("");
    const { error } = await supabase.rpc("add_book_to_library", {
      book_google_id:book.googleBooksId, book_title:book.title, book_authors:book.authors,
